...
export const HabitStatsList = memo(function HabitStatsList() {
  ...
  return (
    <div className="space-y-3" role="list" aria-label="Estatísticas por hábito">
      {allStats.map((stat) => {
        ...
        return (
          <div
            key={stat.habitId}
            className="rounded-2xl bg-white/5 p-4 backdrop-blur-xl border border-white/8 shadow-[0_4px_16px_0_rgba(0,0,0,0.25)] hover:bg-white/8 transition-all"
            role="listitem"
            aria-label={`Estatísticas de ${habit.title}: ${stat.completionRate}% de conclusão, streak de ${stat.currentStreak} dias`}
          >
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-lg font-bold text-white" aria-label={`Streak atual: ${stat.currentStreak} dias`}>
                  {stat.currentStreak}
                </p>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-lg font-bold text-white" aria-label={`Melhor streak: ${stat.longestStreak} dias`}>
                  {stat.longestStreak}
                </p>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-lg font-bold text-white" aria-label={`Total de conclusões: ${stat.totalCompletions}`}>
